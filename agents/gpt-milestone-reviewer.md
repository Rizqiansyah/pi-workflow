---
name: gpt-milestone-reviewer
description: GPT 5.6 Sol reviewer for milestone pull requests against milestone goals, requirements, scope, regressions, incompleteness, incorrectness, scope creep, and residual risk.
